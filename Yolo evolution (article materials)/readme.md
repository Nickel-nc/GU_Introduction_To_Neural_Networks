...
Разработана для нейронной сети на основе DarkNet. Позволяет обучаться на небольшом наборе данных, чтобы эффективно распознавать объекты в реальном времени

<img src="imgs/YOLO v.1.PNG" alt="YOLO v.1" width="800"/>
...
### [YOLO9000 (YOLO v.2):](https://arxiv.org/pdf/1612.08242.pdf)

<img src="imgs/YOLO v.2.PNG" alt="YOLO v.2" width="800"/>
...
<img src="imgs/YOLO v.3.PNG" alt="YOLO v.3" width="800"/>
...
<img src="imgs/YOLO v.3 architecture.PNG" alt="YOLO v.3 architecture" width="800"/>
